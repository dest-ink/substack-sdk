...
export type { PaginatedPosts } from '@substack-api/internal/services/post-service'
...
export type { FollowingUser } from '@substack-api/internal/services/following-service'
